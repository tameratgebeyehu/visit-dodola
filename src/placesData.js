export const placesData = [
  {
    ...
    travelTip: {
      en: 'Bring warm clothes as temperatures drop significantly at night.',
      am: 'ምሽት ላይ ቅዝቃዜው ስለሚጨምር ሞቅ ያሉ ልብሶችን ይዘው ይምጡ።',
      or: 'Halkan qabbanni waan dabaluuf uffata ho’aa qabadhaa.',
    },
  ...
  },
  {
    ...
    travelTip: {
      en: 'The market is most active early Saturday mornings.',
      am: 'ገበያው ቅዳሜ ጠዋት በጠዋት በጣም ይደመቃል።',
      or: 'Gabaan kun sa’aatii ganamatti guyyaa Sanbataa baay’ee ho’aa dha.',
    },
  ...
  },
  {
    ...
    image: require('../assets/images/forest_trails.jpg'),
    coordinates: {
      latitude: 6.9700,
      longitude: 39.1500,
    },
